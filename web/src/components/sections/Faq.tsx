...
const FAQS = [
  ...
  },
  {
    ...
    a: "Our all-inclusive packages typically cover the clinical programme, accommodation, airport transfers, hospital induction, certificate of completion, and 24/7 support during your stay. Optional tours and cultural activities are available as add-ons. You'll receive a personalised quote after you apply.",
  },
  {
