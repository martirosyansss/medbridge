...
import { COOKIE_CONSENT_EVENT, readCookieChoice } from "@/lib/cookieConsent"

export function WhatsAppButton() {
  const [consented, setConsented] = useState(() => readCookieChoice() !== null)

  useEffect(() => {
    const onChange = () => setConsented(readCookieChoice() !== null)
  ...
  return (
    <a
      ...
      className="fixed z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/40 transition-transform hover:scale-105 lg:!bottom-7 lg:!right-7"
    >
